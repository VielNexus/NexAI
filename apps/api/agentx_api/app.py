...
from agentx_api.routes.coding_zone import router as coding_zone_router
...
def create_app() -> FastAPI:
    ...
    app.include_router(coding_zone_router, prefix="/v1", dependencies=[Depends(require_api_auth)])
