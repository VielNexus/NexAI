...
- Expected behavior:
  - if there is an unambiguous recent file in working memory, AgentX reads it with `fs.read_text`
  - otherwise AgentX returns a grounded clarification
- Success looks like:
